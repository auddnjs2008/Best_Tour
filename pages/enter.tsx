...
const Enter: NextPage = () => {
    return (
        <div className="mx-auto max-w-sm p-10 mt-10 space-y-20 rounded-lg border-black border-2 ">
            ...
            <form className="flex flex-col ">
                ...
                <button className="p-3 hover:bg-black hover:text-white">Login</button>
            </form>
            <div>
                <Link href="/signup">
