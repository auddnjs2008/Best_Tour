...
const SignUp: NextPage = () => {
    return <div className="mx-auto max-w-sm p-10 mt-10 space-y-16 rounded-lg border-black border-2 ">
        ...
        <form className="flex flex-col ">
            ...
            <button className="p-3 hover:bg-black hover:text-white">Sign Up</button>
        </form>
        <div>
            <Link href="/enter">
